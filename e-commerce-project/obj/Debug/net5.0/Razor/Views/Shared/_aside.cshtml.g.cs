#pragma checksum "C:\Users\user\Desktop\mvc-ecommerce\e-commerce-project\Views\Shared\_aside.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b0084327c8d63928112945be5eb13ff804589789"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b0084327c8d63928112945be5eb13ff804589789", @"/Views/Shared/_aside.cshtml")]
    ...
    <ul class=""nav flex-column pt-3 pt-md-0"">
      <li class=""nav-item  active "">
        <a href=""../../pages/dashboard/dashboard.html"" class=""nav-link"">
          <span class=""sidebar-icon"">
            <svg class=""icon icon-xs me-2"" fill=""currentColor"" viewBox=""0 0 20 20"" xmlns=""http");
            WriteLiteral(@"://www.w3.org/2000/svg""><path d=""M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z""></path><path d=""M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z""></path></svg>
          </span> 
      ...
      <li class=""nav-item "">
        <a href=""../../pages/settings.html"" class=""nav-link"">
          <span class=""sidebar-icon"">
            <svg class=""icon icon-xs me-2"" fill=""currentColor"" viewBox=""0 0 20 20"" xmlns=""http://www.w3.org/2000/svg""><path fill-rule=""evenodd"" d=""M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.5");
            WriteLiteral(@"32 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z"" clip-rule=""evenodd""></path></svg>
          </span>
      ...
      <li class=""nav-item"">
        <a href=""https://demo.themesberg.com/volt-pro/pages/calendar.html"" target=""_blank"" class=""nav-link d-flex justify-content-between"">
          <span>
            <span class=""sidebar-icon"">
              <svg class=""icon icon-xs me-2"" fill=""currentColor"" viewBox=""0 0 20 20"" xmlns=""http://www.w3.org/2000/svg""><path fill-rule=""evenodd"" d=""M12 1.586l-4 4v12.828l4-4V1.586zM3.707 3.293A1 1 0 002 4v10a1 1 0 00.293.707L6 18.414V5.586L3.707 3.293zM17.707 5.293L14 1.586v12.828l2.293 2.293A1 1 0 0018 16V6a1 1");
            WriteLiteral(@" 0 00-.293-.707z"" clip-rule=""evenodd""></path></svg>
            </span>
      ...
      <li class=""nav-item"">
        <span
          ...
          data-bs-toggle=""collapse"" ");
            WriteLiteral(@"data-bs-target=""#submenu-app"">
          <span>
            <span class=""sidebar-icon"">
      ...
      <li class=""nav-item"">
        <span
          ...
          <span class=""link-arrow"">
     ");
            WriteLiteral(@"       <svg class=""icon icon-sm"" fill=""currentColor"" viewBox=""0 0 20 20"" xmlns=""http://www.w3.org/2000/svg""><path fill-rule=""evenodd"" d=""M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"" clip-rule=""evenodd""></path></svg>
          </span>
        </span>
        <div class=""multi-level collapse "" role=""list""
          ...
          <ul class=""flex-column nav"">
           ...
           ");
            WriteLiteral(@"     <span class=""sidebar-text"">Forgot password</span>
              </a>
            </li>
            <li class=""nav-item"">
          ...
          <ul class=""flex-column nav"">
            ...
            <li class=""nav-item "">
              <a class=""nav-link"" href=""../../pages/components/forms.html"">
                <span c");
            WriteLiteral(@"lass=""sidebar-text"">Forms</span>
              </a>
            </li>
            <li class=""nav-item "">
